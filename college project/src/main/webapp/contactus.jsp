        ...
        <div class="container mt-5 intro-page">
            <div class="row justify-content-around text-center">
                <div class="col-lg-9 pt-5">
                    <u>
                        <h2>WELCOME TO IGIT, SARANG</h2>
                    </u>
                    <p>Indira Gandhi Institute of Technology (IGIT), Sarang was established in the year of 1982 and was
                        managed directly by the
                        Govt. of Odisha in the name of Odisha College of Engineering (OCE). Prior to this, since 1981, the
                        institute in the name
                        of Modern Polytechnic (MPT) was offering Diploma Courses in Civil, Electrical, Mechanical, Mining
                        Survey Engineering.In
                        the year 1987, both OCE & MPT were merged and renamed as IGIT, Sarang and the management was
                        transferred to an
                        Autonomous Society.</p>
                </div>
                <div class="col-lg-3">
                    <div class="card">
                        <img src="./media/igit1.jpg" class="card-img-top" alt="..." height="210px">
                        <div class="card-body">
