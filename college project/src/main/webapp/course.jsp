                        ...
                        <table class="table table-striped">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>20CAC102</td>
                                    <td><a class="Course" href="./courses/sub2.jsp">Computer Organization
                                            and Architecture</a></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>20CAS102</td>
                                    <td><a class="Course" href="./courses/M_math.jsp">Discrete Mathematics</a></td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>20CAH101</td>
                                    <td><a class="Course" href="./courses/M_english.jsp">Communicative English</a></td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>20CAH102</td>
                                    <td><a class="Course" href="./courses/M_eco.jsp">Engineering Economics &
                                            Accounting</a></td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>20CAL101</td>
                                    <td><a class="Course" href="./courses/M_clab.jsp">Problem Solving using C
                                            Lab
                                        </a></td>
                                </tr>
                                <tr>
                                    <td>7</td>
                                    <td>20CAL102</td>
                                    <td><a class="Course" href="./courses/M_eng_lab.jsp">Communicative English
                                            Lab
                                        </a></td>
                                </tr>
                                <tr>
                                    <td>8</td>
                                    <td>20CAL103</td>
                                    <td><a class="Course" href="./courses/M_coa_lab.jsp">Computer Organization
                                            Lab
                                        </a></td>
                                </tr>
                                ...
                                <tr>
                                    <td>9</td>
                                    <td>20CAC203</td>
                                    <td><a class="Course" href="./courses/Mca_cpp.jsp">OOPs Using C++</a></td>
                                </tr>
                                <tr>
                                    <td>10</td>
                                    <td>20CAC204</td>
                                    <td><a class="Course" href="./courses/Mca_OS.jsp">Operating System</a></td>
                                </tr>
                                <tr>
                                    <td>11</td>
                                    <td>20CAC205</td>
                                    <td><a class="Course" href="./courses/Mca_Dbms.jsp">Database Management
                                            System</a></td>
                                </tr>
                                <tr>
                                    <td>12</td>
                                    <td>20CAC206</td>
                                    <td><a class="Course" href="./courses/Mca_dad.jsp">Design of Algorithms
